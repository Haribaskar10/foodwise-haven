      ...
      <main className="container mx-auto px-6 py-8">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <Button className="bg-sage-600 hover:bg-sage-700 text-white">Add Items</Button>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <Button className="bg-sage-600 hover:bg-sage-700 text-white">Find Recipes</Button>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <Button className="bg-sage-600 hover:bg-sage-700 text-white">Find Donation Centers</Button>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <Button className="bg-sage-600 hover:bg-sage-700 text-white">Plan Meals</Button>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <Button className="bg-sage-600 hover:bg-sage-700 text-white">Join Discussion</Button>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <Button className="bg-sage-600 hover:bg-sage-700 text-white">View Stats</Button>
          </div>
        </div>
      </main>
    </div>
