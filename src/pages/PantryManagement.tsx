      ...
      <div className="container mx-auto px-6 py-20">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-xl shadow-md p-8 mb-8">
            <h2 className="text-xl font-semibold mb-4">Track Your Food Items</h2>
            <p className="text-gray-600 mb-6">
              Log in to start managing your pantry inventory. You'll be able to:
            </p>
            <ul className="space-y-2 mb-6">
              <li className="flex items-start">
                ...
                <span>Add items with expiration dates</span>
              </li>
              <li className="flex items-start">
                <div className="bg-sage-100 rounded-full p-1 mr-3 mt-1">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-sage-600">
                ...
                <span>Receive notifications when food is about to expire</span>
              </li>
              <li className="flex items-start">
                <div className="bg-sage-100 rounded-full p-1 mr-3 mt-1">
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-sage-600">
                ...
                <span>Categorize and organize your food items</span>
              </li>
            </ul>
